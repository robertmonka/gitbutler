						...
						<>
							...
							<Field.Root render={<FieldRootStyles />}>
								...
								<Field.Control
									render={<FieldControlStyles />}
									type="url"
									placeholder="Only when the web UI differs from the API"
									value={viewHost}
	...
	return (
		<>
			...
			<ForgeCard
				...
				tokenHint="API URL of the Gitea instance, plus a personal access token. Add a view URL only when the web UI differs from the API."
				needsHost
